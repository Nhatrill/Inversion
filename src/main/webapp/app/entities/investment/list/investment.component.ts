...
export class InvestmentComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.investmentService
      ...
      .subscribe({
        next: (res: HttpResponse<IInvestment[]>) => {
  ...
  trackId(index: number, item: IInvestment): string {
    return item.id!;
  }
  ...
  protected onSuccess(data: IInvestment[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
