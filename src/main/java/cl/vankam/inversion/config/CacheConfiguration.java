package cl.vankam.inversion.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, cl.vankam.inversion.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, cl.vankam.inversion.repository.UserRepository.USERS_BY_EMAIL_CACHE);
